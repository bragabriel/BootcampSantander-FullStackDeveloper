# TypeScript
O objetivo desse repositório é mostrar exemplos e desafios de typescript que vão dar uma noção geral suficiente da ferramenta para que ela seja usada no dia a dia do desenvolvedor. As aulas foram ministradas pelo João Santos pela plataforma DIO.
