...
public class map {
	...
	public static void main(String[] args) {
		 ...
		 * - É um objeto que dentro dele podemos colocar multiplos elementos
	...
	*/
	...
	Map<String, Double> carrosPopulares = new HashMap<>() {
		{
			put("gol", 14.4); //Chave precisa ser de valor único! não pode repetir
			put("uno", 15.6);
			put("mobi", 16.1);
			put("hb20", 14.5);
			put("kwid", 15.6);
    ...
    // System.out.println("Exiba o terceiro modelo adicionado: "); -> Não tem como
    
    
    System.out.println("Exiba os modelos: ");
    Set<String> modelos = carrosPopulares.keySet(); //Retorna um set. Armazenando na variável 'modelos' do tipo 'string'
