...
public class ex1_arcoIris {
	...
	public static void main(String[] args) {
		...
		/*
		 * Crie uma conjunto contendo as cores do arco-íris e: a) Exiba todas as cores o
		 * arco-íris uma abaixo da outra; b) A quantidade de cores que o arco-íris tem;
		 * c) Exiba as cores em ordem alfabética; d) Exiba as cores na ordem inversa da
		 * que foi informada; e) Exiba todas as cores que começam com a letra ”v”; f)
		 * Remova todas as cores que não começam com a letra “v”; g) Limpe o conjunto;
